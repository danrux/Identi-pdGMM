"""model piecewise affine encoder and decoder"""
...
# this function is modified based on https://github.com/ysharma1126/ssl_identifiability
def get_mlp(n_in: int, n_out: int,
            layers: List[int],
            layer_normalization: Union[None, Literal["bn"], Literal["gn"]] = None,
            output_normalization: Union[None, Literal["bn"], Literal["gn"], Literal["softmax"]] = None,
            output_layer: Union[None, Literal["sigmoid"],Literal["softmax"]] = None,
